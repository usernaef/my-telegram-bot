...
# ذخیره آخرین زمان بررسی برای هر گروه
last_check = {}
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # بررسی فاصله زمانی از آخرین چک
    if chat_id in last_check:
        if (current_time - last_check[chat_id]) < timedelta(minutes=10):
            return

    last_check[chat_id] = current_time
